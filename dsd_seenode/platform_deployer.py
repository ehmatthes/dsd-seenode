"""Manages all seenode-specific aspects of the deployment process.
...
class PlatformDeployer:
    """Perform the initial deployment to seenode
    ...
    def deploy(self, *args, **options):
        ...
        plugin_utils.write_output("\nConfiguring project for deployment to seenode...")
    ...
    def _validate_platform(self):
        """Make sure the local environment and project supports deployment to seenode.
    ...
    def _conclude_automate_all(self):
        """Finish automating the push to seenode.
        ...
        # Push project.
        plugin_utils.write_output("  Deploying to seenode...")
