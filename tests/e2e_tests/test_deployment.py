...
def test_deployment(tmp_project, cli_options, request):
    """Test the full, live deployment process to seenode."""

    # Cache the platform name for teardown work.
    request.config.cache.set("platform", "dsd_seenode")

    print("\nTesting deployment to seenode using the following options:")
